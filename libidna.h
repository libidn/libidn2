...
typedef enum
{
  ...
  LIBIDNA_MALLOC_ERROR,
  LIBIDNA_CHECK_NFC_FAIL,
  LIBIDNA_CHECK_2HYPHEN_FAIL,
  LIBIDNA_CHECK_COMBINING_FAIL,
  LIBIDNA_CHECK_DISALLOWED_FAIL,
  LIBIDNA_CHECK_CONTEXTJ_FAIL,
  LIBIDNA_NFC_FAIL,
  LIBIDNA_UNKNOWN_WHAT
} libidna_rc;
